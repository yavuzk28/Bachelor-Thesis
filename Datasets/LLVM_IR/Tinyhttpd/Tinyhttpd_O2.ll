; ModuleID = '/home/yavuzk28/Github/Bachelor-Thesis/Datasets/LLVM_BC/Tinyhttpd/Tinyhttpd_O2.bc'
...
define dso_local void @serve_file(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  ...
  store i8 65, ptr %5, align 16, !tbaa !5
  %6 = getelementptr inbounds nuw i8, ptr %5, i64 1
  store i8 0, ptr %6, align 1, !tbaa !5
  %7 = load i16, ptr %5, align 16
  %8 = icmp eq i16 %7, 10
...
10:                                               ; preds = %32, %9
  %11 = phi i64 [ %35, %32 ], [ 0, %9 ]
  %12 = call i64 @recv(i32 noundef %0, ptr noundef nonnull %4, i64 noundef 1, i32 noundef 0) #16
...
18:                                               ; preds = %15
  %19 = call i64 @recv(i32 noundef %0, ptr noundef nonnull %4, i64 noundef 1, i32 noundef 2) #16
...
25:                                               ; preds = %18
  %26 = call i64 @recv(i32 noundef %0, ptr noundef nonnull %4, i64 noundef 1, i32 noundef 0) #16
  %27 = load i8, ptr %4, align 1, !tbaa !5
  br label %32

28:                                               ; preds = %18
  %29 = trunc nuw nsw i64 %11 to i32
  %30 = getelementptr inbounds nuw i8, ptr %5, i64 %11
  store i8 10, ptr %30, align 1, !tbaa !5
  %31 = add nuw nsw i32 %29, 1
  br label %42

32:                                               ; preds = %25, %15
  %33 = phi i8 [ %27, %25 ], [ %16, %15 ]
  %34 = getelementptr inbounds nuw i8, ptr %5, i64 %11
  store i8 %33, ptr %34, align 1, !tbaa !5
  %35 = add nuw nsw i64 %11, 1
  %36 = icmp ne i8 %33, 10
  %37 = icmp samesign ult i64 %11, 1022
  %38 = select i1 %37, i1 %36, i1 false
  br i1 %38, label %10, label %39, !llvm.loop !8

39:                                               ; preds = %10, %32
  %40 = phi i64 [ %35, %32 ], [ %11, %10 ]
  %41 = trunc i64 %40 to i32
  br label %42

42:                                               ; preds = %39, %28
  %43 = phi i32 [ %31, %28 ], [ %41, %39 ]
  ...
  %47 = load i16, ptr %5, align 16
  %48 = icmp eq i16 %47, 10
  %49 = select i1 %46, i1 true, i1 %48
  br i1 %49, label %50, label %9, !llvm.loop !25

50:                                               ; preds = %42, %2
  %51 = call noalias ptr @fopen(ptr noundef %1, ptr noundef nonnull @.str.26)
...
54:                                               ; preds = %50
  ...
  %55 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %3) #18
  %56 = call i64 @send(i32 noundef %0, ptr noundef nonnull %3, i64 noundef %55, i32 noundef 0) #16
  ...
  %57 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %3) #18
  %58 = call i64 @send(i32 noundef %0, ptr noundef nonnull %3, i64 noundef %57, i32 noundef 0) #16
  ...
  %59 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %3) #18
  %60 = call i64 @send(i32 noundef %0, ptr noundef nonnull %3, i64 noundef %59, i32 noundef 0) #16
  ...
  %61 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %3) #18
  %62 = call i64 @send(i32 noundef %0, ptr noundef nonnull %3, i64 noundef %61, i32 noundef 0) #16
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %3) #16
  call void @cat(i32 noundef %0, ptr noundef nonnull %51)
  br label %63

63:                                               ; preds = %54, %53
  %64 = call i32 @fclose(ptr noundef %51)
...
59:                                               ; preds = %56, %45
  ...
  br i1 %66, label %171, label %26, !llvm.loop !26
...
155:                                              ; preds = %152, %141
  ...
  br i1 %162, label %163, label %114, !llvm.loop !27
...
212:                                              ; preds = %208
  ...
  %216 = load i32, ptr %14, align 4, !tbaa !28
...
235:                                              ; preds = %208
  ...
  %239 = load i32, ptr %14, align 4, !tbaa !28
...
247:                                              ; preds = %245, %247
  ...
  %250 = load i32, ptr %246, align 4, !tbaa !28
  ...
  br i1 %253, label %254, label %247, !llvm.loop !29

254:                                              ; preds = %247, %235
  %255 = load i32, ptr %13, align 4, !tbaa !28
...
258:                                              ; preds = %254, %258
  ...
  %260 = load i32, ptr %13, align 4, !tbaa !28
  %261 = call i64 @read(i32 noundef %260, ptr noundef nonnull %16, i64 noundef 1) #16
  %262 = icmp sgt i64 %261, 0
  br i1 %262, label %258, label %263, !llvm.loop !30

263:                                              ; preds = %258, %254
  %264 = load i32, ptr %13, align 4, !tbaa !28
