; ModuleID = '/home/yavuzk28/Documents/GitHub/Thesis/Dataset/Compiled/2048.c/2048.c_O2.bc'
...
117:                                              ; preds = %117, %114
  ...
  br i1 %122, label %123, label %117, !llvm.loop !11
...
131:                                              ; preds = %129, %123
  ...
  br i1 %134, label %135, label %97, !llvm.loop !13
...
135:                                              ; preds = %131
  ...
  br i1 %195, label %196, label %34, !llvm.loop !14
...
37:                                               ; preds = %35
  ...
  %40 = shl nuw i32 1, %39
  %41 = load i32, ptr %1, align 4, !tbaa !15
  %42 = add i32 %41, %40
  store i32 %42, ptr %1, align 4, !tbaa !15
  %43 = add i8 %27, 1
  br label %44
...
46:                                               ; preds = %3, %44, %26
  ...
  %50 = icmp eq i64 %49, 4
  br i1 %50, label %51, label %3, !llvm.loop !17
...
41:                                               ; preds = %39
  ...
  %44 = shl nuw i32 1, %43
  %45 = load i32, ptr %1, align 4, !tbaa !15
  %46 = add i32 %45, %44
  store i32 %46, ptr %1, align 4, !tbaa !15
  %47 = add i8 %31, 1
  br label %48
...
50:                                               ; preds = %48, %30, %7
  ...
  %54 = icmp eq i64 %53, 4
  br i1 %54, label %55, label %7, !llvm.loop !17
...
43:                                               ; preds = %41
  ...
  %46 = shl nuw i32 1, %45
  %47 = load i32, ptr %1, align 4, !tbaa !15
  %48 = add i32 %47, %46
  store i32 %48, ptr %1, align 4, !tbaa !15
  %49 = add i8 %33, 1
  br label %50
...
define dso_local noundef zeroext i1 @findPairDown(ptr noundef readonly captures(none) %0) local_unnamed_addr #10 {
  ...
  %5 = icmp eq i8 %2, %4
  br i1 %5, label %56, label %6, !llvm.loop !19

6:                                                ; preds = %1
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 2
  %8 = load i8, ptr %7, align 1, !tbaa !10
  %9 = icmp eq i8 %4, %8
  br i1 %9, label %56, label %10, !llvm.loop !19

10:                                               ; preds = %6
  %11 = getelementptr inbounds nuw i8, ptr %0, i64 3
  %12 = load i8, ptr %11, align 1, !tbaa !10
  %13 = icmp eq i8 %8, %12
  br i1 %13, label %56, label %14, !llvm.loop !19
...
define dso_local zeroext i1 @gameEnded(ptr noundef readonly captures(none) %0) local_unnamed_addr #10 {
  ...
  br i1 %62, label %97, label %63, !llvm.loop !19
...
11:                                               ; preds = %9
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) @setBufferedInput.old, ptr noundef nonnull align 4 dereferenceable(60) %2, i64 60, i1 false), !tbaa.struct !20
...
5:                                                ; preds = %61
  ...
  %7 = icmp eq i64 %6, 13
  br i1 %7, label %126, label %8, !llvm.loop !23
...
56:                                               ; preds = %53, %36, %13
  ...
  %60 = icmp eq i64 %59, 4
  br i1 %60, label %61, label %13, !llvm.loop !17
...
75:                                               ; preds = %70
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) @setBufferedInput.old, ptr noundef nonnull align 4 dereferenceable(60) %3, i64 60, i1 false), !tbaa.struct !20
...
84:                                               ; preds = %91, %82
  %85 = load ptr, ptr @stdin, align 8, !tbaa !24
...
143:                                              ; preds = %140, %123, %99
  ...
  br i1 %148, label %149, label %99, !llvm.loop !17

149:                                              ; preds = %143
  %150 = or i1 %97, %145
  %151 = add nuw nsw i64 %96, 1
  %152 = icmp eq i64 %151, 4
  br i1 %152, label %155, label %94, !llvm.loop !18
...
162:                                              ; preds = %84, %160
  ...
  %164 = load ptr, ptr @stdin, align 8, !tbaa !24
...
172:                                              ; preds = %169
  ...
  %174 = load ptr, ptr @stdin, align 8, !tbaa !24
  %175 = call i32 @getc(ptr noundef %174)
  %176 = icmp eq i32 %175, 121
  br i1 %176, label %181, label %177

177:                                              ; preds = %172
  %178 = load i32, ptr %5, align 4, !tbaa !15
  br label %179
...
!18 = distinct !{!18, !12}
!19 = distinct !{!19, !12}
!20 = !{i64 0, i64 4, !15, i64 4, i64 4, !15, i64 8, i64 4, !15, i64 12, i64 4, !15, i64 16, i64 1, !10, i64 17, i64 32, !10, i64 52, i64 4, !10, i64 56, i64 4, !10}
!21 = !{!22, !16, i64 12}
!22 = !{!"termios", !16, i64 0, !16, i64 4, !16, i64 8, !16, i64 12, !8, i64 16, !8, i64 17, !8, i64 52, !8, i64 56}
!23 = distinct !{!23, !12}
!24 = !{!25, !25, i64 0}
