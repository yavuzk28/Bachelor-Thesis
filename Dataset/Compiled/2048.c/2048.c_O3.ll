; ModuleID = '/home/yavuzk28/Documents/GitHub/Thesis/Dataset/Compiled/2048.c/2048.c_O3.bc'
...
114:                                              ; preds = %114, %111
  ...
  br i1 %119, label %120, label %114, !llvm.loop !11
...
147:                                              ; preds = %147, %144
  ...
  br i1 %152, label %153, label %147, !llvm.loop !11
...
180:                                              ; preds = %180, %177
  ...
  br i1 %185, label %186, label %180, !llvm.loop !11
...
213:                                              ; preds = %213, %210
  ...
  br i1 %218, label %219, label %213, !llvm.loop !11
...
227:                                              ; preds = %225, %219
  ...
  br i1 %288, label %289, label %34, !llvm.loop !13
...
16:                                               ; preds = %14
  ...
  %19 = shl nuw i32 1, %18
  %20 = load i32, ptr %1, align 4, !tbaa !14
  %21 = add i32 %20, %19
...
55:                                               ; preds = %53
  ...
  %60 = add i32 %59, %58
  store i32 %60, ptr %1, align 4, !tbaa !14
  %61 = add nsw i8 %48, 1
  br label %63
...
93:                                               ; preds = %91
  ...
  %96 = shl nuw i32 1, %95
  %97 = load i32, ptr %1, align 4, !tbaa !14
  %98 = add i32 %97, %96
  store i32 %98, ptr %1, align 4, !tbaa !14
  br label %100
...
define dso_local zeroext i1 @gameEnded(ptr noundef readonly captures(none) %0) local_unnamed_addr #10 {
  ...
  br i1 %62, label %97, label %63, !llvm.loop !16
...
11:                                               ; preds = %9
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) @setBufferedInput.old, ptr noundef nonnull align 4 dereferenceable(60) %2, i64 60, i1 false), !tbaa.struct !17
...
6:                                                ; preds = %9
  ...
  %8 = icmp eq i64 %7, 13
  br i1 %8, label %80, label %9, !llvm.loop !20
...
75:                                               ; preds = %70
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) @setBufferedInput.old, ptr noundef nonnull align 4 dereferenceable(60) %3, i64 60, i1 false), !tbaa.struct !17
...
85:                                               ; preds = %92, %81
  %86 = load ptr, ptr @stdin, align 8, !tbaa !21
...
109:                                              ; preds = %85, %107
  ...
  %111 = load ptr, ptr @stdin, align 8, !tbaa !21
...
119:                                              ; preds = %116
  ...
  %121 = load ptr, ptr @stdin, align 8, !tbaa !21
...
!15 = !{!"int", !8, i64 0}
!16 = distinct !{!16, !12}
!17 = !{i64 0, i64 4, !14, i64 4, i64 4, !14, i64 8, i64 4, !14, i64 12, i64 4, !14, i64 16, i64 1, !10, i64 17, i64 32, !10, i64 52, i64 4, !10, i64 56, i64 4, !10}
!18 = !{!19, !15, i64 12}
!19 = !{!"termios", !15, i64 0, !15, i64 4, !15, i64 8, !15, i64 12, !8, i64 16, !8, i64 17, !8, i64 52, !8, i64 56}
!20 = distinct !{!20, !12}
!21 = !{!22, !22, i64 0}
